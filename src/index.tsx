          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button 
                ...
                className="w-5 h-5 rounded-full bg-slate-100 hover:bg-slate-200 flex items-center justify-center text-[11px] font-black text-slate-500 hover:text-indigo-600 transition-all shadow-sm cursor-pointer active:scale-90"
                title="Informations & Guide"
              >
                i
              </button>
            </div>
        ...
        <div className="h-full w-full">
          ...
          {activeView === 'SETTINGS' && (
            <Settings 
              ...
              onReset={handleReset} onLogout={() => setState(prev => ({ ...prev, user: null }))} onShowWelcome={() => setShowWelcome(true)} 
              onBackup={() => {
