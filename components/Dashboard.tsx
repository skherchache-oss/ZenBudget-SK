...
const Dashboard: React.FC<DashboardProps> = ({ 
  ...
  // Fonction d'appel à l'IA optimisée pour Vercel
      ...
      const response = await fetch(
        `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${apiKey}`,
        {
          ...
          body: JSON.stringify({
            contents: [{
              parts: [{
                text: `Tu es un coach financier ZenBudget. Dispo: ${availableBalance}€, Dépenses: ${stats.expenses}€. Donne 1 conseil court (60 car max). Pas de guillemets.`
              }]
            }]
          })
        }
