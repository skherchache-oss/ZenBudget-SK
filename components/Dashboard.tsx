...
const Dashboard: React.FC<DashboardProps> = ({ 
  ...
  const handleExportCSV = () => {
    ...
    link.href = url; link.download = `ZenBudget_${activeAccount.name.replace(/\s+/g, '_')}_Export.csv`; link.click();
  };
  ...
  return (
    <div className="flex flex-col h-full space-y-6 overflow-y-auto no-scrollbar pb-32 px-1 fade-in">
      ...
      <div className="bg-slate-900 px-6 py-10 rounded-[48px] shadow-2xl relative overflow-visible flex flex-col justify-center min-h-[140px] group transition-all">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <div className="h-1.5 w-full bg-slate-50 rounded-full overflow-hidden">
               <div className="h-full bg-emerald-500 rounded-full transition-all duration-700" style={{ width: stats.income > 0 ? '100%' : '0%' }} />
            </div>
          </div>
          <div className="space-y-1">
            ...
            <div className="h-1.5 w-full bg-slate-50 rounded-full overflow-hidden">
               <div className="h-full bg-red-400 rounded-full transition-all duration-700" style={{ width: stats.expenses > 0 ? '100%' : '0%' }} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
               <div className="w-9 h-9 rounded-xl bg-indigo-50 flex items-center justify-center text-sm">⚓️</div>
               <div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
               <div className="w-9 h-9 rounded-xl bg-amber-50 flex items-center justify-center text-sm">🪁</div>
               <div>
                 <p className="text-[10px] font-black text-slate-800 uppercase leading-none">Charges Variables</p>
                 <p className="text-[9px] text-slate-400 font-bold mt-1">Vie courante, imprévus...</p>
               </div>
            </div>
            <div className="text-right">
